 ...
 export default function SignUpForm() {
  ...
  return (
    <div className="min-h-screen w-[100%] flex items-center justify-center bg-gray-900">
      <div className="max-w-[600px] w-full  p-8 rounded-lg shadow-lg">
        ...
        <div className="mt-6 text-center text-gray-400">
          ...
          <button onClick={()=>handleLogin()} className="flex items-center  border border-gray-300 
          rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
